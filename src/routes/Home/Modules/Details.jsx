              ...
              <Grid item xs={12} md={6}>
                ...
                <div className={classes.detailsWrap}>
                  ...
                  <Typography variant="body1" className={classes.text}>
                    ...
                    can be used to validate data and prove its veracity. We also
                    took care to ensure that our data and data processing is
                    blockchain-agnostic. Let’s face it, the blockchain
